...
const mockEventValue = new Date("2021-10-08T19:00:00.000Z");
...
beforeAll(() => {
  ...
  jest.setSystemTime(new Date("2021-10-08T19:00:00.000Z"));
});
...
describe("<DateInput />", () => {
  it("Updates the date when it is changed", () => {
    ...
    const newDate = new Date("2021-10-08T19:00:00.000Z");
