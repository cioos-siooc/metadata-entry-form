      ...
      <Paper style={paperClass}>
        <QuestionText>
          <En>
            ...
            are related to the primary resources this metadata record describes.
          </En>
          <Fr>
            Entrez des liens vers d'autres enregistrements de métadonnées,
            publications ou ouvrages qui sont liés aux ressources principales
            décrites par cet enregistrement de métadonnées.
          </Fr>
          <RequiredMark
              ...
              <En>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    that describe the same dataset
                  </li>
                  <li>
                    Any work that adds context to or describes the primary
                    resource for which you are creating this metadata record for
                  </li>
                </ul>
              </En>
              <Fr>
                ...
                <ul>
                  ...
                  <li>
                    Enregistrements de métadonnées sur d'autres catalogues tels
                    que OBIS ou FRDR qui décrivent le même ensemble de données
                  </li>
                  <li>
                    Tout travail qui ajoute du contexte ou décrit la ressource
                    principale pour laquelle vous créez cet enregistrement de
                    métadonnées
                  </li>
                </ul>
              </Fr>
