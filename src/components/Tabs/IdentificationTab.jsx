...
const IdentificationTab = ({
  ...
  async function handleGenerateDOI(){
    ...
    try {
      await createDraftDoi(record).then(
          response => {
      ...
      <div>
        <Paper style={paperClass}>
          <QuestionText>
            <I18n>
              <En>
                What is the dataset title? Required in English and French.
              </En>
              <Fr>
            ...
            <SupplementalText>
              <I18n>
                <En>
                  ...
                  <p>
                    Title should be precise enough so that the user will not
                    have to open the dataset to understand its contents. Title
                    should not have acronyms, special characters, or use
                    specialized nomenclature. This will appear as the title that
                    is shown for this dataset in the{" "}
                    {regionInfo.catalogueTitle.en}.
                  </p>
                </En>
                <Fr>
                  <p>Le titre recommandé comprend : Quoi, Où, Quand.</p>
                  <p>
                    Le titre doit être suffisamment précis pour que
                    l'utilisateur n'ait pas à ouvrir le ensemble de données pour
                    comprendre son contenu. Le titre ne doit pas avoir des
                    acronymes, des caractères spéciaux ou utiliser une
                    nomenclature spécialisée. Ceci apparaîtra comme titre de
                    votre jeu de données dans le {regionInfo.catalogueTitle.fr}.
                  </p>
                </Fr>
              </I18n>
            </SupplementalText>
          ...
          <Paper style={paperClass}>
            <QuestionText>
              <I18n>
                ...
                <Fr>
                  Quels sont les projets dont ce disque fait partie? Pour
                  ajouter un projet, e-mail{" "}
                </Fr>
              </I18n>
            ...
            <SupplementalText>
              <I18n>
                <En>
                  ...
                  for this dataset in the {regionInfo.catalogueTitle.en}.
                  Browsing datasets at <CatalogueLink lang="en" /> can help
                  provide a sense of the type of descriptions that are typically
                  used for this section of the record. As a general rule, this
                  section should be worded with as little jargon as possible to
                  give potential users an understanding of your dataset. Use a
                  maximum of 500 words. For detailed methods please submit
                  supplemental materials with your data.
                  <br />
                  <br />
                ...
                <Fr>
                  ...
                  résumé, vous pouvez vous inspirer d’autres jeux de données
                  déjà publiés dans le catalogue. Ce champ doit être compris par
                  tout type d’utilisateur, nous vous recommandons un maximum de
                  500 mots, l’utilisation d’un langage accessible et de limiter
                  ...
                  <div>
                    <ul>
                      ...
                      <li>
                        <b>Où</b>: Couverture spatiale de la donnée, nom/lieu
                        des sites d’échantillonnages, déplacement enregistrés
                        d’un capteur, laboratoire, etc.
                      </li>
                      <li>
                      ...
                      <li>
                        <b>Pourquoi</b>: Quelques lignes pour décrire le
                        contexte dans lequel les données ont été échantillonnées
                        et comment elles permettent de répondre à la
                        problématique (p. ex: quelles informations peuvent-elles
                        apporter)
                      </li>
                    </ul>
                  </div>
        ...
        <Paper style={paperClass}>
          <QuestionText>
            <I18n>
              <En>
                Please select all the essential ocean variables that are
                contained in this dataset. Hover over a variable to see its
                definition.
              </En>
              <Fr>
                Veuillez sélectionner toutes les variables océaniques
                essentielles contenues dans ce jeu de données. Survolez une
                variable pour voir sa définition ou cliquez sur l’icône{" "}
                <OpenInNew /> pour accéder à la définition complète du Système
                d’Observatoire Global des Océans (GOOS).
              </Fr>
            </I18n>
          ...
          <Grid container spacing={3} direction="column">
            <Grid item xs>
              <QuestionText>
                <I18n>
                  <En>
                    Choose the most specific keywords that apply to your data,
                    or create your own.
                  </En>
                  <Fr>
                ...
                <SupplementalText>
                  <I18n>
                    <En>
                      <p>
                        Keywords are an important way to categorize your data
                        that allow people and other systems to search for
                        datasets that share some important characteristics.
                      </p>
                      <p>
                    ...
                    <Fr>
                      ...
                      <p>
                        ...
                        (vérifiez toujours si son équivalent existe dans la
                        liste déroulante afin de diminuer le risque d’écriture
        ...
        <Paper style={paperClass}>
          ...
          <QuestionText>
            <I18n>
              <En>
                What is the end date when data was last collected? Leave blank
                if data collection is ongoing.
              </En>
              <Fr>
                Inscrivez la date de fin de votre collecte de données. Laissez
                le champs vide si la collecte des données toujours est en cours.
              </Fr>
            </I18n>
          </QuestionText>
          <DateInput
        ...
        <Paper style={paperClass}>
          <QuestionText>
            <I18n>
              ...
              <Fr>
                Le numéro de version de cet ensemble de données. Par exemple,
                1.1
              </Fr>
            </I18n>
          </QuestionText>
                ...
                <En>
                  <ul>
                    <li>
                      ...
                      - CIOOS recommended. Allows for open sharing and
                      adaptation of the data provided that the original creator
                      is attributed.
                    </li>
                    <li>
                      <b>
                    ...
                    <li>
                      ...
                      departments and agencies, it is very similar to CC-BY as
                      it allows for open sharing and adaptation of the data,
                      provided that the original creator of the data is properly
                      attributed.
                    </li>
                  </ul>
                </En>
                <Fr>
                  <ul>
                    ...
                    <li>
                      ...
                      particulière : le jeu de données peut être utilisé sans
                      être cité.
                    </li>
                    <li>
                      <b>Licence du gouvernement ouvert - Canada</b> - Pour les
                      jeux de données rendus disponibles par les organisations
                      et ministères fédéraux. Cette licence est similaire à
                      CC-BY 4.0 : les données sont ouvertes mais le jeu de
                      données doit être cité lorsqu'il est utilisé par un autre
                      utilisateur.
                    </li>
                  </ul>
                </Fr>
